...
class TestStructuredLogger:
    ...
    def test_json_logging(self, temp_log_file):
        ...
        logger = StructuredLogger(name="test_logger", output_file=temp_log_file)
...
class TestRequestTracker:
    ...
    def test_request_with_provided_ids(self):
        ...
        context = tracker.start_request(
            request_id="custom-req-id", trace_id="custom-trace-id"
        )
...
class TestConfigureObservability:
    ...
    def test_disable_components(self):
        ...
        configure_observability(enable_metrics=False, enable_tracing=False)
...
class TestIntegration:
    ...
    def test_full_request_flow(self):
        ...
        configure_observability(
            log_level="DEBUG", enable_metrics=True, enable_tracing=True
        )
        ...
        # Log completion
        logger.info(
            "Command completed", metadata={"success": True, "duration": duration}
        )
