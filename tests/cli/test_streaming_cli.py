...
from openagent.cli import _build_http_headers, _build_ws_url_and_headers
...
def test_build_ws_url_default_path_http_no_auth():
    ...
    ws_url, headers = _build_ws_url_and_headers(
        api_url, ws_path, api_token=None, token_query_key=None, auth_header_value=None
    )
