...
'''
    ...
    @pytest.mark.asyncio
    async def test_load_plugin_initialization_failure(self, loader, temp_dir, test_helpers):
...
class Plugin{i}(BasePlugin):
    ...
    async def shutdown(self):
        pass
'''
            test_helpers.create_temp_file(
                temp_dir, f"plugin_{i}.py", plugin_content
            )
