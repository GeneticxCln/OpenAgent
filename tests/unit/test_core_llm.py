...
class TestHuggingFaceLLM:
    ...
    def test_llm_initialization_basic(self):
        ...
        with patch("openagent.core.llm.psutil"):
            llm = HuggingFaceLLM(
                model_name=self.model_name, device="cpu", temperature=0.5
            )
    ...
    async def test_load_model_success(self):
        ...
        with (
            patch("openagent.core.llm.AutoTokenizer") as mock_tokenizer,
    ...
    async def test_load_model_fallback_seq2seq(self):
        ...
        with (
            ...
            mock_causal_model.from_pretrained.side_effect = Exception(
                "Not a causal model"
            )
    ...
    def test_get_model_info(self):
        ...
        with patch("openagent.core.llm.psutil"):
            llm = HuggingFaceLLM(
                model_name=self.model_name, device="cpu", temperature=0.7, top_p=0.9
            )
...
class TestGetLLM:
    ...
    def test_get_llm_creates_instance(self):
        ...
        with (
            patch("openagent.core.llm.HuggingFaceLLM") as mock_llm_class,
            patch("openagent.core.llm.llm", None),
        ):  # Reset global
