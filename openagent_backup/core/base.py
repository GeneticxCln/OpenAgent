...
class BaseTool(ABC):
    ...
    def __init__(self, name: str, description: str, **kwargs: Any) -> None:
        ...
        self.config = kwargs
        # Optional capabilities/tags to help planning and relevance gating
        self.capabilities: List[str] = list(kwargs.get("capabilities", []))
    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "parameters": self.config.get("schema", {}),  # optional JSON-like schema
            "returns": {
                "success": "boolean",
