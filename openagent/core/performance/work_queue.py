...
class WorkQueue:
    ...
    def __init__(
        ...
        logger.info(f"WorkQueue initialized: max_workers={max_workers}, max_queue_size={max_queue_size}")
    ...
    async def submit(
        ...
        **kwargs
        ...
        logger.debug(f"Task submitted: {request_id} (priority={priority.name}, user={user_id})")
    ...
    async def get_user_status(self, user_id: str) -> Dict[str, Any]:
        ...
        current_rate = len([
            t for t in self._user_rate_tracker[user_id]
