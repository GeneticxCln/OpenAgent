...
class WebSocketMessage(BaseModel):
    ...
    room_id: Optional[str] = Field(
        None, description="Room identifier for collaboration"
    )

    # Response correlation
    request_id: Optional[str] = Field(
        None, description="ID of the request this responds to"
    )
    is_response: bool = Field(False, description="Whether this is a response message")

    # Streaming support
    stream_id: Optional[str] = Field(
        None, description="Stream identifier for chunked responses"
    )
    ...
    def create_error(
        ...
        data = {"error": error_msg, "code": error_code or "UNKNOWN_ERROR"}
